...
const steps = [
  { number: '01', title: 'Create Your Profile', description: 'Sign up easily and securely to get started with personalized maternal care.' },
  { number: '02', title: 'Choose Your Service', description: 'Browse and book a consultation, track symptoms, or access guidance resources.' },
  { number: '03', title: 'Connect with Support', description: 'Get expert advice and emergency support whenever you need it most.' },
];

const stats = [
  { value: '2,500+', label: 'Healthy Mothers' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -bottom-8 -left-8 bg-card shadow-card rounded-xl p-4 max-w-[200px]"
              >
                <div className="text-primary text-2xl mb-2">"</div>
                <p className="text-xs text-muted-foreground">Amazing care and support throughout my entire pregnancy journey!</p>
      ...
      <section id="about" className="py-20 bg-primary/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {stats.map((stat, i) => (
                <Card key={i} className="text-center p-6 border-0 bg-card shadow-soft">
